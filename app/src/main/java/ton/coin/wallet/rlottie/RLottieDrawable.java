...
package ton.coin.wallet.rlottie;
...
/**
 * DO NOT MOVE OUTSIDE ton.coin.wallet.rlottie PACKAGE
 */
public class RLottieDrawable extends BitmapDrawable implements Animatable {
    ...
    public RLottieDrawable(int rawRes, String name, int w, int h, boolean startDecode) {
        try {
            InputStream inputStream = TonApplication.Companion.getInstance().getApplicationContext().getResources().openRawResource(rawRes);
            int readLen;
            int totalRead = 0;
