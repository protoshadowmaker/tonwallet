...
class StepCongratulationsController : ViewModelController() {
        ...
        val content = LinearLayout(context).apply {
            ...
            addView(
                coloredButton(context).apply {
                    setText(R.string.congrats_proceed)
